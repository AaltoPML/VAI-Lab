...
class PageManual(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        pixels = 500
        path = os.path.join(self.dirpath, 'Example_images')
        ...
        self.back_img = ImageTk.PhotoImage(Image.open(os.path.join(self.dirpath,'Icons','back_arrow.png')).resize((150, 50)))
        self.forw_img = ImageTk.PhotoImage(Image.open(os.path.join(self.dirpath,'Icons','forw_arrow.png')).resize((150, 50)))
